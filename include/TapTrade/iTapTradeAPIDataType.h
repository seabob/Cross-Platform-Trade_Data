...
#pragma pack(push, 1)
    ...
    */
    ...
    struct TapAPINewOrder
    {
            ...
            TAPISTR_10					ClientID;						///<客户子账号，如果存在子账号，则自行上报子账号
    ...
    //! 成交查询请求结构
    typedef TapAPIOrderQryReq TapAPIFillQryReq;
    ...
    */
    ...
    struct TapAPITradeMessage
    {
            ...
            TAPIMsgReceiverType		TMsgReceiverType;				///< 消息接收者类型
            union
            {
                    TAPISTR_20				AccountNo;						///< 客户资金账号
                    TAPISTR_10				AccountGroupNo;					///< 组号
